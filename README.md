...
const obj = useRelationshipField(data.doc.relationshipField, 'collectionSlug') // RelationshipType | null
const arr = useRelationshipFieldArray(data.doc.relationshipHasManyField, 'collectionSlug') // RelationshipType[]
</script>
```
